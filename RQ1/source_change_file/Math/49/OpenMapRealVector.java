...
public class OpenMapRealVector extends AbstractRealVector implements SparseRealVector, Serializable {
    ...
    /** {@inheritDoc} */
    @Override public RealVector add(RealVector v) {
    ...
    /** {@inheritDoc} */
    @Override public OpenMapRealVector ebeDivide(double[] v) {
    ...
    /** {@inheritDoc} */
    @Override public OpenMapRealVector ebeMultiply(double[] v) {
        checkVectorDimensions(v.length);
        OpenMapRealVector res = new OpenMapRealVector(this);
        Iterator iter = res.entries.iterator();
        while (iter.hasNext()) {
    ...
    /** {@inheritDoc} */
    @Override public double getDistance(RealVector v) {
        checkVectorDimensions(v.getDimension());
        if (v instanceof OpenMapRealVector) {
    ...
    /** {@inheritDoc} */
    @Override public double getDistance(double[] v) {
        checkVectorDimensions(v.length);
        double res = 0;
    ...
    /** {@inheritDoc} */
    @Override public double getL1Distance(RealVector v) {
        checkVectorDimensions(v.getDimension());
        if (v instanceof OpenMapRealVector) {
    ...
    /** {@inheritDoc} */
    @Override public double getL1Distance(double[] v) {
        checkVectorDimensions(v.length);
        double max = 0;
        for (int i = 0; i < v.length; i++) {
    ...
    /** {@inheritDoc} */
    @Override public double getLInfDistance(RealVector v) {
        checkVectorDimensions(v.getDimension());
        if (v instanceof OpenMapRealVector) {
    ...
    /** {@inheritDoc} */
    @Override public double getLInfDistance(double[] v) {
        checkVectorDimensions(v.length);
        double max = 0;
        for (int i = 0; i < v.length; i++) {
            double delta = FastMath.abs(getEntry(i) - v[i]);
    ...
    @Override public OpenMapRealVector mapAddToSelf(double d) {
     ...
     /** {@inheritDoc} */
    @Override public RealMatrix outerProduct(double[] v) {
    ...
    /** {@inheritDoc} */
    @Override public OpenMapRealVector projection(double[] v) {
        checkVectorDimensions(v.length);
    ...
    /** {@inheritDoc} */
    @Override public void setSubVector(int index, double[] v) {
        checkIndex(index);
    ...
    /** {@inheritDoc} */
    @Override public OpenMapRealVector subtract(RealVector v) {
        checkVectorDimensions(v.getDimension());
        if (v instanceof OpenMapRealVector) {
    ...
    /** {@inheritDoc} */
    @Override public OpenMapRealVector subtract(double[] v) {
        checkVectorDimensions(v.length);
        OpenMapRealVector res = new OpenMapRealVector(this);
        for (int i = 0; i < v.length; i++) {
    ...
    /** {@inheritDoc} */
    @Override public OpenMapRealVector unitVector() {
        OpenMapRealVector res = copy();
        res.unitize();
        return res;
    }
