...
public class FastMath {
    ...
    private static void splitReciprocal(final double in[], final double result[]) {
        ...
        if (result[1] != result[1]) { // can happen if result[1] is NAN result[1] = 0.0;
        }
    ...
    public static double log1p(final double x) {
        ...
        if (x > 0 && 1/x == 0) { // x = Infinity return x;
        }
    ...
    private static void reducePayneHanek(double x, double result[]) {
        ...
        /* Convert to double */
        double tmpA = (prod2A >>> 12) / 4503599627370496.0;  // High order 52 bits double tmpB = (((prod2A & 0xfffL) << 40) + (prod2B >>> 24)) / 4503599627370496.0 / 4503599627370496.0; // Low bits
    ...
    private static double atan(double xa, double xb, boolean leftPlane) {
        ...
        if (xa > 1.633123935319537E16) { // Very large input return (negate ^ leftPlane) ? (-Math.PI/2.0) : (Math.PI/2.0);
        }
    ...
    public static double atan2(double y, double x) {
        ...
        if (y == 0.0) {
            ...
            if (invx == 0.0) { // X is infinite if (x > 0) {
                    return 0.0;
                } else {
                    return Math.PI;
                }
            ...
            if (result != result) { // y must be infinite return x/y;
            }
        ...
        if (x > 8e298 || x < -8e298) { // This would cause split of x to fail x *= 9.31322574615478515625E-10;
