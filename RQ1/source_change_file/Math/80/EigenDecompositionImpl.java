...
public class EigenDecompositionImpl implements EigenDecomposition {
    ...
    private void computeShiftIncrement(final int start, final int end, final int deflated) {
        ...
        case 0 : // no realEigenvalues deflated. if (dMin == dN || dMin == dN1) {
        ...
        case 1 : // one eigenvalue just deflated. use dMin1, dN1 for dMin and dN. if (dMin1 == dN1 && dMin2 == dN2) {
        ...
        default : // case 12, more than two realEigenvalues deflated. no information. tau   = 0.0;
            tType = -12;
        }
