...
public class NormalDistributionImpl extends AbstractContinuousDistribution implements NormalDistribution, Serializable {
     ...
     */
    @Override public double inverseCumulativeProbability(final double p) throws MathException {
        if (p == 0) {
     ...
     */
    @Override public double sample() throws MathException {
     ...
     */
    @Override protected double getDomainLowerBound(double p) {
        double ret;
     ...
     */
    @Override protected double getDomainUpperBound(double p) {
        double ret;
     ...
     */
    @Override protected double getInitialDomain(double p) {
        double ret;
