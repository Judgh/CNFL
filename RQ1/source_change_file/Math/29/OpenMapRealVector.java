...
public class OpenMapRealVector extends SparseRealVector implements Serializable {
    ...
    /** {@inheritDoc} */
    @Override public OpenMapRealVector ebeDivide(RealVector v) {
        checkVectorDimensions(v.getDimension());
    ...
    /** {@inheritDoc} */
    @Override public OpenMapRealVector ebeMultiply(RealVector v) {
        checkVectorDimensions(v.getDimension());
        OpenMapRealVector res = new OpenMapRealVector(this);
        Iterator iter = entries.iterator();
        while (iter.hasNext()) {
    ...
    /** {@inheritDoc} */
    @Override public OpenMapRealVector getSubVector(int index, int n) {
        checkIndex(index);
        if (n < 0) {
    ...
    /** {@inheritDoc} */
    @Override public RealVector projection(RealVector v) {
        checkVectorDimensions(v.getDimension());
    ...
    /** {@inheritDoc} */
    @Override public RealVector subtract(RealVector v) {
        checkVectorDimensions(v.getDimension());
        if (v instanceof OpenMapRealVector) {
