  ...
  private class ProcessProperties implements NodeTraversal.ScopedCallback {
    ...
    public boolean shouldTraverse(NodeTraversal t, Node n, Node parent) {
      if (isPrototypePropertyAssign(n)) {
        ...
        String name = parent.getType() == Token.NAME ? parent.getString() /* VAR */ : n.getFirstChild().getString() /* named function */;
    ...
    public void visit(NodeTraversal t, Node n, Node parent) {
      if (n.getType() == Token.GETPROP) {
        ...
        if (propName.equals("prototype")) {
          ...
          !(parent.getType() == Token.ASSIGN && parent.getFirstChild().getType() == Token.GETPROP && parent.getFirstChild().getLastChild().getString().equals( "prototype"))) {
        // var x = {a: 1, b: 2}
      ...
      if (isPrototypePropertyAssign(n) || isGlobalFunctionDeclaration(t, n) || NodeUtil.isFunction(n)) {
        symbolStack.pop();
      }
    }
    ...
    private boolean isGlobalFunctionDeclaration(NodeTraversal t, Node n) {
      return t.inGlobalScope() && (NodeUtil.isFunctionDeclaration(n) || n.getType() == Token.FUNCTION && n.getParent().getType() == Token.NAME);
    }
    ...
    private boolean processGlobalFunctionDeclaration(NodeTraversal t, Node nameNode, Node parent, Node gramps) {
      ...
      if (// Check for a named FUNCTION. isGlobalFunctionDeclaration(t, parent) ||
    ...
    private void processPrototypeParent(NodeTraversal t, Node n) {
      switch (n.getType()) {
        ...
        // Foo.prototype = { "getBar" : function() { ... } }
        case Token.ASSIGN: Node map = n.getFirstChild().getNext();
