    ...
    if (!hasOwnProperty(name)) {
      if ("call".equals(name)) {
        ...
        if (params == null) {
          ...
          defineDeclaredProperty(name, new FunctionBuilder(registry) .withParamsNode(params) .withReturnType(getReturnType()) .build(), source);
        }
  ...
  @Override public boolean isSubtype(JSType that) {
    ...
    if (that.isFunctionType()) {
      ...
      boolean treatThisTypesAsCovariant =
        ...
        (other.typeOfThis.getConstructor() != null && other.typeOfThis.getConstructor().isInterface()) ||
