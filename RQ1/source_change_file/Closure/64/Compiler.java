...
public class Compiler extends AbstractCompiler {
  ...
  @SuppressWarnings("unchecked") static <T> T runCallable( final Callable<T> callable, boolean useLargeStackThread, boolean trace) {
  ...
  @Override public CompilerInput getInput(String name) {
  ...
  @Override Config getParserConfig() {
    if (parserConfig == null) {
      ...
      parserConfig = ParserRunner.createConfig( isIdeMode(), mode, acceptConstKeyword());
    }
    return parserConfig;
  }
  ...
  @Override ReferenceMap getGlobalVarReferences() {
    return globalRefMap;
  }
