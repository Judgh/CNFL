...
public class FunctionType extends PrototypeObjectType {
  ...
  @Override public boolean isFunctionType() {
    return true;
  }
  ...
  @Override public boolean hasOwnProperty(String name) {
  ...
  @Override boolean defineProperty(String name, JSType type, boolean inferred, boolean inExterns) {
    if ("prototype".equals(name)) {
   ...
   */
  @Override public boolean isEquivalentTo(JSType otherType) {
