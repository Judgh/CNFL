...
class UnreachableCodeElimination implements CompilerPass {
  ...
  @Override public void process(Node externs, Node toplevel) {
    NodeTraversal.traverseChangedFunctions(compiler, new FunctionCallback() {
        @Override public void visit(AbstractCompiler compiler, Node root) {
  ...
  private class EliminationPass extends AbstractShallowCallback {
    ...
    @Override public void visit(NodeTraversal t, Node n, Node parent) {
      ...
      if (gNode == null) { // Not in CFG. return;
      }
     ...
     */
    @SuppressWarnings("fallthrough") private void tryRemoveUnconditionalBranching(Node n) {
      /*
      ...
      switch (n.getType()) {
        case Token.RETURN: if (n.hasChildren()) {
            break;
          }
    ...
    private void removeDeadExprStatementSafely(Node n) {
      ...
      switch (n.getType()) {
        ...
        case Token.CATCH: Node tryNode = parent.getParent();
