...
class TypeInference extends DataFlowAnalysis.BranchedForwardDataFlowAnalysis<Node, FlowScope> {
  ...
  @Override @SuppressWarnings({"fallthrough", "incomplete-switch"}) List<FlowScope> branchedFlowThrough(Node source, FlowScope input) {
  ...
  private FlowScope traverse(Node n, FlowScope scope) {
    switch (n.getType()) {
      ...
      case Token.POS: case Token.NEG: scope = traverse(n.getFirstChild(), scope);  // Find types. n.setJSType(getNativeType(NUMBER_TYPE));
        break;
  ...
  private void updateBind(Node n) {
    ...
    n.setJSType( callTargetFn.getBindReturnType(
