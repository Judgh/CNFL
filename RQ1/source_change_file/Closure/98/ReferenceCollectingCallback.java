...
class ReferenceCollectingCallback implements ScopedCallback, CompilerPass {
  ...
  private static boolean isBlockBoundary(Node n, Node parent) {
    if (parent != null) {
      switch (parent.getType()) {
        case Token.DO: case Token.FOR: case Token.TRY: case Token.WHILE: case Token.WITH:
        case Token.FOR: case Token.TRY: case Token.WHILE: case Token.WITH:
        case Token.TRY: case Token.WHILE: case Token.WITH:
        case Token.WHILE: case Token.WITH:
        case Token.WITH:
        ...
        case Token.HOOK: case Token.IF: case Token.OR:
  ...
  interface Behavior {
     ...
     */
    void afterExitScope(NodeTraversal t, Map<Var, ReferenceCollection> referenceMap);
  }

  static Behavior DO_NOTHING_BEHAVIOR = new Behavior() {
    @Override public void afterExitScope(NodeTraversal t, Map<Var, ReferenceCollection> referenceMap) {}
  };
  ...
  static final class Reference {
    ...
    Reference(Node nameNode, Node parent, NodeTraversal t, BasicBlock basicBlock) {
    ...
    static Reference newBleedingFunction(NodeTraversal t, BasicBlock basicBlock, Node func) {
      return new Reference(func.getFirstChild(), func, func.getParent(), basicBlock, t.getScope(), t.getSourceName());
    }

    private Reference(Node nameNode, Node parent, Node grandparent, BasicBlock basicBlock, Scope scope, String sourceName) {
    ...
    */
    Node getAssignedValue() {
      return (parent.getType() == Token.FUNCTION) ? parent : NodeUtil.getAssignedValue(getNameNode());
    }
    ...
    boolean isSimpleAssignmentToName() {
      return parent.getType() == Token.ASSIGN && parent.getFirstChild() == nameNode;
    }
