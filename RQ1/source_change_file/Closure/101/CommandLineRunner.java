...
public class CommandLineRunner extends AbstractCommandLineRunner<Compiler, CompilerOptions> {
  ...
  private static class Flags {
    ...
    @Option(name = "--print_pass_graph", usage = "Prints a dot file describing the passes that will get run" + " and exits") private boolean print_pass_graph = false;
    ...
    @Option(name = "--charset", usage = "Input charset for all files.") private String charset = "";
