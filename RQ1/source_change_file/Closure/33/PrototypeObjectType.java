...
class PrototypeObjectType extends ObjectType {
   ...
   */
  @Override public int getPropertiesCount() {
    ObjectType implicitPrototype = getImplicitPrototype();
    if (implicitPrototype == null) {
  ...
  @Override public boolean hasOwnProperty(String propertyName) {
  ...
  @Override public boolean isPropertyTypeDeclared(String property) {
  ...
  @Override void collectPropertyNames(Set<String> props) {
  ...
  @Override public boolean isPropertyTypeInferred(String property) {
    StaticSlot<JSType> slot = getSlot(property);
    if (slot == null) {
      return false;
    }
  ...
  @Override public JSType getPropertyType(String property) {
    StaticSlot<JSType> slot = getSlot(property);
    if (slot == null) {
  ...
  @Override public boolean isPropertyInExterns(String propertyName) {
  ...
  @Override public Node getPropertyNode(String propertyName) {
    Property p = properties.get(propertyName);
    if (p != null) {
      return p.getNode();
    }
