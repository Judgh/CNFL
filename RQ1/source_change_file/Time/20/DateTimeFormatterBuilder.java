...
public class DateTimeFormatterBuilder {
    ...
    public DateTimeFormatterBuilder appendLiteral(String text) {
        ...
        switch (text.length()) {
            case 0: return this;
            case 1: return append0(new CharacterLiteral(text.charAt(0)));
            default: return append0(new StringLiteral(text));
        }
    }
    ...
    static class TimeZoneName implements DateTimePrinter, DateTimeParser {
        ...
        private String print(long instant, DateTimeZone displayZone, Locale locale) {
            ...
            switch (iType) {
                case LONG_NAME: return displayZone.getName(instant, locale);
                case SHORT_NAME: return displayZone.getShortName(instant, locale);
            }
            return "";
        }
