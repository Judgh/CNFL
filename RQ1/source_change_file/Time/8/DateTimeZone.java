...
public abstract class DateTimeZone implements Serializable {
                ...
                if (zone == null) {
                    ...
                    try {
                        try {
                            ...
                            if (id != null) {  // null check avoids stack overflow temp = forID(id);
                            }
    ...
    private static synchronized String getConvertedId(String id) {
        ...
        if (map == null) {
            ...
            map.put("HST", "Pacific/Honolulu");  // JDK 1.1 compatible map.put("AST", "America/Anchorage");
            map.put("PST", "America/Los_Angeles");
            map.put("MST", "America/Denver");  // JDK 1.1 compatible map.put("PNT", "America/Phoenix");
            map.put("CST", "America/Chicago");
            map.put("EST", "America/New_York");  // JDK 1.1 compatible map.put("IET", "America/Indiana/Indianapolis");
