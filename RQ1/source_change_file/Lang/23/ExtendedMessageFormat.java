...
public class ExtendedMessageFormat extends MessageFormat {
     ...
     */
    @Override public final void applyPattern(String pattern) {
        if (registry == null) {
        ...
        while (pos.getIndex() < pattern.length()) {
            ...
            case QUOTE: appendQuotedString(pattern, pos, stripCustom, true);
                break;
            case START_FE: fmtCount++;
     ...
     */
    @Override public void setFormat(int formatElementIndex, Format newFormat) {
     ...
     * @throws UnsupportedOperationException
     */
    @Override public void setFormatByArgumentIndex(int argumentIndex, Format newFormat) {
        throw new UnsupportedOperationException();
    }
     ...
     * @throws UnsupportedOperationException
     */
    @Override public void setFormats(Format[] newFormats) {
        throw new UnsupportedOperationException();
    }
     ...
     * @throws UnsupportedOperationException
     */
    @Override public void setFormatsByArgumentIndex(Format[] newFormats) {
        throw new UnsupportedOperationException();
    }
    ...
    private String parseFormatDescription(String pattern, ParsePosition pos) {
        ...
        for (; pos.getIndex() < pattern.length(); next(pos)) {
            ...
            case END_FE: depth--;
                ...
                break;
            case QUOTE: getQuotedString(pattern, pos, false);
                break;
            }
        }
        throw new IllegalArgumentException( "Unterminated format element at position " + start);
    ...
    private String insertFormats(String pattern, ArrayList<String> customPatterns) {
        ...
        while (pos.getIndex() < pattern.length()) {
            char c = pattern.charAt(pos.getIndex());
            switch (c) {
            case QUOTE: appendQuotedString(pattern, pos, sb, false);
                break;
            case START_FE: depth++;
                if (depth == 1) {
                    fe++;
