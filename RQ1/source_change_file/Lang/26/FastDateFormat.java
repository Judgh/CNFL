...
public class FastDateFormat extends Format {
    ...
    public static synchronized FastDateFormat getInstance(String pattern, TimeZone timeZone, Locale locale) {
        ...
        if (format == null) {
            format = emptyFormat;
            format.init();  // convert shell format into usable one cInstanceCache.put(format, format);  // this is OK!
    ...
    public StringBuffer format(Calendar calendar, StringBuffer buf) {
        if (mTimeZoneForced) {
            calendar.getTimeInMillis(); /// LANG-538 calendar = (Calendar) calendar.clone();
